...
def get_euler_3d(x, t, gamma, R, mu, Pr, u): 
    assert(len(u) == 5)
    Cv     = R/(gamma - 1)
    v      = [0, 0, 0] #Velocity
    rho    = u[0]
...
def get_cns_3d(x, t, gamma, R, mu, Pr, u): 
    ...
    f_vis[3] = tau13 
    #FIXME
    f_vis[4] = v[0]*tau11 + v[1]*tau12 + v[2]*tau13 + (mu*Cp/Pr)*T_x
    ...
    g_vis[3] = tau23 
    #FIXME
    g_vis[4] = v[0]*tau21 + v[1]*tau22 + v[2]*tau23 + (mu*Cp/Pr)*T_y
    ...
    h_vis[3] = tau33 
    #FIXME
    h_vis[4] = v[0]*tau31 + v[1]*tau32 + v[2]*tau33 + (mu*Cp/Pr)*T_z
...
def get_cns_2d(x, t, gamma, R, mu, Pr, u): 
    ...
    f_vis[2] = tau12 
    #FIXME
    f_vis[3] = v[0]*tau11 + v[1]*tau12 + (mu*Cp/Pr)*T_x
    ...
    g_vis[2] = tau22 
    #FIXME
    g_vis[3] = v[0]*tau21 + v[1]*tau22 + (mu*Cp/Pr)*T_y
...
def smooth_density_3d():
    ...
    rho   = 1 + 0.2*smp.sin(smp.pi*(x[1] + x[2] - t*(v[1] + v[2])))
