...
def is_technical_command(line: str) -> bool:
    ...
    chat_patterns = [
        "does all that research",
        "what? just the case",
        "add a guidance note",
        "and then why did you stop",
        "do you think this is going to work",
        "go search for the docs",
        "is the new plan better",
        "isn't your experiment plan",
        "you completely got rid",
        "no, you should make",
        "first update the plan",
        "now tell me again",
        "why doesn't it appear",
        "you just said to me",
        "is the training still",
        "is there some way to verify",
        "why why do you",
        "give me your plan",
        "that is when the plan stops",
        "why is the moonshine document",
        "let's actually reread",
        "does it end abruptly",
        "read again the guidance",
        "i don't want any tests",
        "now updatge @agents",
        "no i only want",
        "i asked a question",
        "is any thing even running",
        "when i go into visual",
        "do you have access",
        "now will you again",
        "why did you pick",
        ...
        "review @_posts",
        "can you add a training",
        "why do i not see",
        "considering how much",
        "i don't know what you are",
        "no edits at all",
        "create docs/personalized_training",
        "move @docs",
        "tell me again what",
        ...
        "can you first update",
        "add your suggestions",
        "read @plan.md",
        "put a to do docstring",
        "review @refactor.md",
        "diagnosis",
        "can we do that as",
        "read docs/",
        "nope don't want this",
        "redo both experiment",
        "again, why",
        "include in @docs",
        "is @plan.md a better",
        "what is fcp",
        ...
        "look @plan",
        "can you use the just",
        "rewrite plan.md",
        "wait, did you make changes",
        "look @docs",
        "why do you have to use",
        "yes, and do not",
        "what is the build manifest",
        "what is this going around",
        "is the revised @plan",
        "read the document again",
        "where are you seeing",
        "@docs/experiment_plan",
        "make the docs string",
        "read exp_",
        "i will remove it",
        "look at all the recent",
        "does the current blog",
        "write a detailed",
        "i have removed your",
        "no, do not add a fix",
        "write a verification",
        "did not ask you to",
        "does @plan.md account",
        "you can use timeout",
        "gf in vsplit",
        "in nvim, how can i",
        ...
        "did you stop monitoring",
        "that is not what i meant",
        "can you create a just file",
        "review again",
        "why do the number of samples",
        "now based on everything",
        "it seems to be plateauing",
        "read @tuning",
        "if a process is working",
        "look at all of our",
        ...
        "don't do head",
        "make sure arguments",
        "continue. you are trying",
        "let's stay on dora",
        "i don't think the job",
        "can i also get",
        "will this achieve what",
        "can you stick to using",
        "why do you think",
        "actually forget that",
        "is there some way to figure",
        "that moonshine paper",
        ...
        "didn't we agree to",
        "i didn't see you download",
        "merge all make files",
        "you have the capability",
        "based on how the training",
        "based on everything you",
        "polling should be via",
        "you're not polling",
        "based on your moonshine",
        "now think hard",
        "no, i even want the ux",
        "what if i'm already",
        "okay, start and do not stop",
        "at least put it as documentation",
        "are the json files generated",
        "but we specifically want",
        "are any of your changes",
        "look @outputs",
        "content from",
        "fix the typose",
        "okay",
